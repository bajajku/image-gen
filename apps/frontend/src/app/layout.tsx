            ...
            <div className="container mx-auto px-4 py-4">
              <div className="flex items-center justify-between">
                ...
                <nav className="flex items-center space-x-1">
                  <Link 
                    href="/train" 
                    className="px-4 py-2 rounded-lg text-gray-700 dark:text-gray-300 hover:text-indigo-600 dark:hover:text-indigo-400 hover:bg-indigo-50 dark:hover:bg-indigo-900/30 font-medium transition-all hover-lift"
                  >
                    Train
                  </Link>
                  <Link 
                    href="/generate" 
                    className="px-4 py-2 rounded-lg text-gray-700 dark:text-gray-300 hover:text-purple-600 dark:hover:text-purple-400 hover:bg-purple-50 dark:hover:bg-purple-900/30 font-medium transition-all hover-lift"
                  >
                    Generate
                  </Link>
                </nav>
            ...
            <div className="container mx-auto px-4 py-6">
              <div className="flex flex-col items-center justify-center space-y-4">
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-sm text-gray-600 dark:text-gray-400">AI Image Generator</span>
                </div>
                <p className="text-sm text-gray-500 dark:text-gray-400">Create stunning AI-generated images with custom trained models</p>
              </div>
            </div>
          </footer>
        </div>
